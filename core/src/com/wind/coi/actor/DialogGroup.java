 ...
 * @date 2024/7/9 14:49
 */
public class DialogGroup extends AbstractBaseGroup {
    ...
    public void init() {
        ...
        okBtnStyle.up = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.DIALOG_BTN_OK, 1));
        okBtnStyle.down = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.DIALOG_BTN_OK, 2));
        ...
        cancelBtnStyle.up = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.DIALOG_BTN_cancel, 1));
        cancelBtnStyle.down = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.DIALOG_BTN_cancel, 2));
