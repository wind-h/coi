 ...
 * @date 2024/7/9 13:34
 */
public class GameOverStage extends AbstractBaseStage {
    ...
    public GameOverStage(MainGame mainGame) {
        super(mainGame);
    }
    ...
    public void init() {
        ...
        msgStyle.font = getMainGame().getFont();
        ...
        backStyle.up = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.BTN_BACK, 1));
        backStyle.down = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.BTN_BACK, 2));
        ...
        againStyle.up = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.BTN_AGAIN, 1));
        againStyle.down = new TextureRegionDrawable(getMainGame().getAtlas().findRegion(ResourceConstant.AtlasNames.BTN_AGAIN, 2));
